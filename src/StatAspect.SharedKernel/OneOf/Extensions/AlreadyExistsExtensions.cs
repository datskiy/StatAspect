...
/// <summary>
/// Provides a set of extension methods for types that implement <see cref="AlreadyExists{TProp}"/>.
/// </summary>
public static class AlreadyExistsExtensions
{
    ...
    /// </summary>
    public static string GetTargetPropertyDisplayName<TProp>(this AlreadyExists<TProp> result) where TProp : struct, IResultTargetPropertyName
    {
        return result
            .GetType()
