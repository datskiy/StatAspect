...
public abstract class BaseApiController : ControllerBase
{
    ...
    /// </summary>
    protected ObjectResult Conflict<TProp>(AlreadyExists<TProp> result) where TProp : struct, IResultTargetPropertyName
    {
        return Problem(
    ...
    protected CreatedResult Created<TController>(ValueIdentity createdId) where TController : BaseApiController
    {
