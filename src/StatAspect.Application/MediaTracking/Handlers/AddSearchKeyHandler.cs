...
/// </summary>
public sealed class AddSearchKeyHandler : IRequestHandler<AddSearchKeyCommand, OneOf<SearchKeyId, AlreadyExists>>
{
    ...
    public Task<OneOf<SearchKeyId, AlreadyExists>> Handle(AddSearchKeyCommand request, CancellationToken cancellationToken)
    {
